...
const items = [
  { id: 1, icon: <SecurityIcon />, textKey: "footer.features.securePayment" },
  { id: 2, icon: <VerifiedIcon />, textKey: "footer.features.certifiedCars" },
  {
    id: 3,
    icon: <LocalShippingIcon />,
    textKey: "footer.features.fastDelivery",
  },
  { id: 4, icon: <StarIcon />, textKey: "footer.features.fiveStarRated" },
];
      ...
      <Grid container spacing={5}>
        ...
        <Grid item lg={12} xs={12}>
          ...
          <Typography sx={{ mt: 7, mb: 3, textAlign: "center" }} variant="h3">
            {t("footer.siteSections.contactUs")}
          </Typography>
          <Stack
            direction="row"
            spacing={{ lg: 15, xs: 5 }}
          ...
          <Stack direction={"row"} justifyContent={"space-evenly"}>
            <Stack gap={1} textAlign={"center"}>
              <Typography variant="h3">
                {t("footer.siteSections.services")}
              </Typography>
              <Link to={"/"}>{t("footer.siteSections.carSearchService")}</Link>
              <Link to={"/"}>{t("footer.siteSections.usedCarEvaluation")}</Link>
            </Stack>

            <Stack gap={1} textAlign={"center"}>
              <Typography variant="h3">
                {t("footer.siteSections.blog")}
              </Typography>
              <Link to={"/news"}>{t("footer.siteSections.carNews")}</Link>
              <Link>{t("footer.siteSections.buyingGuide")}</Link>
              <Link>{t("footer.siteSections.carComparison")}</Link>
            </Stack>

            <Stack gap={1} textAlign={"center"}>
              <Typography variant="h3">
                {t("footer.siteSections.sitePolicies")}
              </Typography>
              <Link>{t("footer.siteSections.termsAndConditions")}</Link>
              <Link>{t("footer.siteSections.cookiesPolicy")}</Link>
            </Stack>
          </Stack>
        </Grid>
        <Grid
        ...
        >
          <SimpleAvatar
            ...
            name={t("footer.avatars.haniJoma.name")}
            text={t("footer.avatars.haniJoma.text")}
          />
        </Grid>
        <Grid item lg={4} xs={12}>
          <Typography my={2} textAlign={"center"} variant="h3">
            {t("footer.features.location")}
          </Typography>
          <iframe
            style={{
          ...
          >
            {items.map((item) => (
              ...
              >
                ...
                <Typography variant="body2">{t(item.textKey)}</Typography>
              </Stack>
            ))}
          </Stack>
        </Grid>
